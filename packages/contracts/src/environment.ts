...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server supports threads that are intentionally not attached to a project.
      Clients must opt into receiving them so older/mobile clients keep their
      project-only shell contract. */
